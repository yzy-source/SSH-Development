							...
							<div class="col-lg-12">
								<div class="col-lg-12">
									<ul id="generalTab" class="nav nav-tabs responsive">
										...
										<li class="active"><a href="customer_addcustomer">添加客户信息</a></li>
										<li><a href="customer_vipsearch">vip客户信息</a></li>
										<li><a href="customer_notvipsearch">非vip客户</a></li>
									</ul>
									
									<div id="generalTabContent" class="tab-content responsive">
										<div id="divcss5" class="panel panel-orange" align="center" style="width:500px">
											<div class="panel-heading">添加客户信息</div>
											<div class="panel-body pan">
												<form action="customer!add" method="post" align="center">
													<input type="hidden" name="uid"
														value="${requestScope.customer.uid}" />
													<div class="form-body pal">
														<div class="form-group">
															<div class="input-icon right">
																<i class="fa fa-user"></i> <input id="inputName"
														...
														<div class="form-group">
															<div class="input-icon right">
																<i class="fa fa-building"></i> <input id="inputAddress"
														...
														<div class="form-group">
															<div class="input-icon right">
																<i class="fa fa-phone"></i> <input id="inputTelephone"
														...
														<div class="form-group">
															<div class="input-icon right">
																<i class="fa fa-gift"></i> <input id="inputIsvip"
																	type="text" placeholder="isvip" name="isvip"
																	class="form-control" />
															</div>
														</div>
														<div class="form-group">
															<div class="input-icon right">
																<i class="fa fa-credit-card"></i> <input
																	id="inputVip_id" type="text" placeholder="vip_id"
																	name="vip_id" class="form-control" />
															</div>
														</div>
														<div class="form-group">
															<div class="input-icon right">
																<i class="fa fa-credit-card"></i> <input
																	id="inputCredit" type="text" placeholder="credit"
																	name="credit" class="form-control" />
															</div>
														</div>
														<div class="form-group">
															<div class="input-icon right">
																<i class="fa fa-star"></i> <input id="inputDegree"
