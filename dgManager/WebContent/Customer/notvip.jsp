							...
							<div class="col-lg-12">
								<div class="col-lg-12">
									<ul id="generalTab" class="nav nav-tabs responsive">
										...
										<li  class="active"><a href="customer_notvipsearch">非vip客户</a></li>
									</ul>
										...
										<div class="panel panel-blue">
											...
											<div class="panel-body">
												<table class="table table-hover table-striped">
													...
													<tbody>
														<c:forEach items="${requestScope.notvip.nvcustomerlist}"
															var="customer">
															<tr>
																<td>${customer.uid}</td>
																...
																<td><a
																	...
																	<span class="badge badge-blue">更改</span>&nbsp;
																</a> </rd></td>
																<td><a href="customer_notvipdelete?uid=${customer.uid}">
																<span class="badge badge-blue">删除</span>&nbsp;</a>
																	</rd></td>																	
															</tr>
														</c:forEach>
													</tbody>
												...
												<table align="center">
																...
																<td>每页&nbsp;&nbsp;${requestScope.notvip.nvpagesize}&nbsp;&nbsp;条记录
										                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										                                                                     共&nbsp;&nbsp;${requestScope.notvip.nvtotalcount}&nbsp;&nbsp;条记录
										                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										                                                                   共&nbsp;&nbsp;${requestScope.notvip.nvtotalpage}&nbsp;&nbsp;页
										                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
																	<td>
																		<ul class="pagination mtm mbm">
																		       <li><a href="customer_notvipsearch?nvcurrentpage=${1}">首页</a></li>
																			    <c:if
																					test="${requestScope.notvip.nvcurrentpage==1}">
																					<li><a href="customer_notvipsearch?nvcurrentpage=${requestScope.notvip.nvcurrentpage}">&laquo;</a></li>

																				</c:if>
																				<c:if
																					test="${requestScope.notvip.nvcurrentpage!=1}">
																					<li><a href="customer_notvipsearch?nvcurrentpage=${requestScope.notvip.nvcurrentpage-1}">&laquo;</a></li>
																				</c:if>
																			<c:forEach begin="1" end="${requestScope.notvip.nvtotalpage}" step="1" var="i">
																				<c:if
																					test="${i==requestScope.notvip.nvcurrentpage}">
																					<li class="active"><a href="#">${i}</a></li>

																				</c:if>
																				<c:if
																					test="${i!=requestScope.notvip.nvcurrentpage}">
																					<li><a href="customer_notvipsearch?nvcurrentpage=${i}">${i}</a></li>
																				</c:if>
																			</c:forEach>
																			<c:if
																					test="${requestScope.notvip.nvcurrentpage==requestScope.notvip.nvtotalpage}">
																					<li><a href="customer_notvipsearch?nvcurrentpage=${requestScope.notvip.nvcurrentpage}">&raquo;</a></li>

																				</c:if>
																				<c:if
																					test="${requestScope.notvip.nvcurrentpage!=requestScope.notvip.nvtotalpage}">
																					<li><a href="customer_notvipsearch?nvcurrentpage=${requestScope.notvip.nvcurrentpage+1}">&raquo;</a></li>
																				</c:if>
																				<li><a href="customer_notvipsearch?nvcurrentpage=${requestScope.notvip.nvtotalpage}">末页</a></li>
																		</ul>
