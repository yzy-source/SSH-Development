							...
							<div class="col-lg-12">
								<div class="col-lg-12">
									<ul id="generalTab" class="nav nav-tabs responsive">
										<li><a href="customer_search">所有客户信息</a></li>
										<li><a href="customer_addcustomer">添加客户信息</a></li>
										<li class="active"><a href="customer_vipsearch">vip客户信息</a></li>
										...
										<div class="panel panel-pink">
											...
											<div class="panel-body">
												<table class="table table-hover table-striped">
													...
													<tbody>
														<c:forEach
															items="${requestScope.vipcustomer.vcustomerlist}"
															var="customer">
															<tr>
																<td>${customer.uid}</td>
																...
																<td><a
																	...
																	<span class="badge badge-pink">修改vip</span>&nbsp;
																</a> </rd></td>
																<td><a href="customer_vipdelete?uid=${customer.uid}">
																<span class="badge badge-pink">删除vip</span>&nbsp;</a>
																	</rd></td>
															</tr>
														</c:forEach>
													</tbody>
												...
												<table align="center">
																...
																<td>每页&nbsp;&nbsp;${requestScope.vipcustomer.vpagesize}&nbsp;&nbsp;条记录
										                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										                                                                     共&nbsp;&nbsp;${requestScope.vipcustomer.vtotalcount}&nbsp;&nbsp;条记录
										                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										                                                                  共&nbsp;&nbsp;${requestScope.vipcustomer.vtotalpage}&nbsp;&nbsp;页
										                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
										                           
																	<td>
																		<ul class="pagination mtm mbm">
																		       <li><a href="customer_vipsearch?vcurrentpage=${1}">首页</a></li>
																			    <c:if
																					test="${requestScope.vipcustomer.vcurrentpage==1}">
																					<li><a href="customer_vipsearch?vcurrentpage=${requestScope.vipcustomer.vcurrentpage}">&laquo;</a></li>

																				</c:if>
																				<c:if
																					test="${requestScope.vipcustomer.vcurrentpage!=1}">
																					<li><a href="customer_vipsearch?vcurrentpage=${requestScope.vipcustomer.vcurrentpage-1}">&laquo;</a></li>
																				</c:if>
																			<c:forEach begin="1" end="${requestScope.vipcustomer.vtotalpage}" step="1" var="i">
																				<c:if
																					test="${i==requestScope.vipcustomer.vcurrentpage}">
																					<li class="active"><a href="#">${i}</a></li>

																				</c:if>
																				<c:if
																					test="${i!=requestScope.vipcustomer.vcurrentpage}">
																					<li><a href="customer_vipsearch?vcurrentpage=${i}">${i}</a></li>
																				</c:if>
																			</c:forEach>
																			<c:if
																					test="${requestScope.vipcustomer.vcurrentpage==requestScope.vipcustomer.vtotalpage}">
																					<li><a href="customer_vipsearch?vcurrentpage=${requestScope.vipcustomer.vcurrentpage}">&raquo;</a></li>

																				</c:if>
																				<c:if
																					test="${requestScope.vipcustomer.vcurrentpage!=requestScope.vipcustomer.vtotalpage}">
																					<li><a href="customer_vipsearch?vcurrentpage=${requestScope.vipcustomer.vcurrentpage+1}">&raquo;</a></li>
																				</c:if>
																				<li><a href="customer_vipsearch?vcurrentpage=${requestScope.vipcustomer.vtotalpage}">末页</a></li>
																		</ul>
