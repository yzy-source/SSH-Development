				...
				<form action="" method="post" class="form-horizontal">
					<div class="form-body pal">
						<div class="col-md-12 text-center">
							<h1 style="margin-top: -90px; font-size: 48px;">是仙女呀</h1>
							<br />
						</div>
							...
							<div class="col-md-9">
								<div class="input-icon right">
									<i class="fa fa-user"></i> <input id="inputName" type="text"
										name="adminName" placeholder="" class="form-control" />
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="input-icon right">
									<i class="fa fa-lock"></i> <input id="inputPassword"
										type="password" name="adminPassword" placeholder=""
										class="form-control" />
								</div>
							</div>
						</div>
								...
								<div class="form-group mbn">
									...
									<div class="col-lg-9">
										<button type="submit" class="btn btn-default"
											formaction="adminlogin!adminLogin">Login</button>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<button type="submit" class="btn btn-default"
											formaction="adminlogin!adminRegister">Register</button>
									</div>
								</div>
							</div>
						</div>
