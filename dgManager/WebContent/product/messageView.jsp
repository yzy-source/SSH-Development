									...
									<div class="panel panel-blue" style="background: #FFF;">
										...
										<div class="panel-body">
											<table class="table table-hover table-bordered">
												...
												<tbody>
													<c:forEach items="${requestScope.product.messageboxes}"
														var="message">
														<tr>
															...
															<td><a href="Product_messDelete?messageID=${message.msgId}&productId=${product.productId}"><span
																class="badge badge-blue">删除</span></a>
															</td>
														</tr>
													</c:forEach>
												</tbody>
