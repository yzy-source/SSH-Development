						...
						<div class="row mbl">
							...
							<div class="col-lg-12">
								<div class="page-content">
									<div class="row">
										<div class="col-lg-12">
											<h4 class="box-heading">更改商品信息</h4>
													...
													<form action="Product_update" method="post"
																...
																<div class="row">
																	<div class="col-xs-9">
																		<input type="text" class="form-control"
																			name="productName" value="${requestScope.product.productName}" />
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9 controls">
																<div class="row">
																	<div class="col-xs-9">
																		<input type="text" class="form-control"
																			name="bname" value="${requestScope.product.brand.bname}" />
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9 controls">
																<div class="row">
																	<div class="col-xs-9">
																		<input type="text" class="form-control" name="price" value="${requestScope.product.price}" />
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9 controls">
																<div class="row">
																	<div class="col-xs-9">
																		<input type="text" class="form-control"
																			name="vipPrice" value="${requestScope.product.vipPrice}"/>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9 controls">
																<div class="row">
																	<div class="col-xs-9">
																		<input type="text" class="form-control"
																			name="primecost" value="${requestScope.product.primecost}" />
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9 controls">
																<div class="row">
																	<div class="col-xs-9">
																		<input type="text" class="form-control"
																			name="sendAddr" value="${requestScope.product.sendAddr}" />
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9 controls">
																<div class="row">
																	<div class="col-xs-9">
																		<input type="text" class="form-control" name="type" value="${requestScope.product.type}"  />
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9 controls">
																<div class="row">
																	<div class="col-xs-9">
																		<input type="text" class="form-control"
																			name="detailInfo"value="${requestScope.product.detailInfo}"  />
																	</div>
																</div>
															</div>
					                                    </div>
														<br>
													    <div class="form-group">
														<button type="submit" class="btn btn-green btn-block" style="width: 100px;margin:auto">更改</button>
														</div>
													</form>
												</div>
											</div>
