					...
					<div id="tab-general">
						<div class="row mbl">
							...
							<div class="panel panel-green">
								<div class="panel-heading">${requestScope.product.productName}</div>
								<div class="panel-body">
									<table class="table table-hover-color">
										<tbody>
											...
											<tr class="tbl-item">
												<td>品牌</td>
												<td>${requestScope.product.brand.bname}</td>
											</tr>
											<tr class="tbl-item">
												<td>国家</td>
												<td>${requestScope.product.brand.country}</td>
											</tr>
											<tr class="tbl-item">
												<td>类型</td>
											...
											<tr class="tbl-item">
												<td>会员价</td>
												<td>${requestScope.product.vipPrice}</td>
											</tr>
											<tr class="tbl-item">
												<td>成本价</td>
												<td>${requestScope.product.primecost}</td>
											</tr>
											<tr class="tbl-item">
												<td>官网售价</td>
												<td>${requestScope.product.webPrice}</td>
											</tr>
											<tr class="tbl-item">
												<td>热门指数</td>
												<td>${requestScope.product.hotLevel}</td>
											</tr>
											<tr class="tbl-item">
												<td>销量</td>
												<td>${requestScope.product.sellAmount}</td>
											</tr>
											<tr class="tbl-item">
												<td>库存总量</td>
												<td>${requestScope.storeNum}</td>
											</tr>
											<tr class="tbl-item">
												<td>留言总量</td>
												<td>${requestScope.messageNum}</td>
											</tr>
											<tr class="tbl-item">
												<td>发货地址</td>
												<td>${requestScope.product.sendAddr}</td>
											</tr>
											<tr class="tbl-item">
												<td>详细信息</td>
												<td>${requestScope.product.detailInfo}</td>
											</tr>
										</tbody>
									</table>
								</div>
