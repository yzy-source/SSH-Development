		...
		<div id="wrapper">
			...
			<div class="sidebar-collapse menu-scroll">
				<ul id="side-menu" class="nav">
					...
					<li class="active"><a href="orderinfo_search"><i class="fa fa-edit fa-fw">
							...
							<div class="col-lg-12">
								<div class="col-lg-12">
									<ul id="generalTab" class="nav nav-tabs responsive">
										<li class="active"><a href="#alert-tab" data-toggle="tab">全部订单</a></li>
										<li><a href="#note-tab" data-toggle="tab">添加订单</a></li>
										<li><a href="#label-badge-tab" data-toggle="tab">订单查询</a></li>
									</ul>
														...
														<div class="panel panel-green">
															...
															<div class="panel-body">
																<table class="table table-hover table-bordered"
																	...
																	<tbody>
																		<c:forEach
																			items="${requestScope.OrderinfoPage.dataList}"
																			var="orderinfo">
																			<tr>
																				<td>${orderinfo.oid }</td>
																				<td>${orderinfo.customer.uid}</td>
																				<td>${orderinfo.orderTime }</td>
																				<td>${orderinfo. totalMoney }</td>
																				<td>${orderinfo.totalAmount }</td>
																				<td>${orderinfo.address}</td>
																				<td><a
																					href="orderinfo_delete?oid=${orderinfo.oid}">删除</a></td>
																				<td><a
																					href="orderinfo_findById?oid=${orderinfo.oid}">修改</a></td>
																			</tr>
																		</c:forEach>
																	</tbody>
																</table>
																<tr>
																	每页${requestScope.OrderinfoPage.pageSize}条记录
																	总共${requestScope.OrderinfoPage.totalPage}页
																	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																	当前：第${requestScope.OrderinfoPage.currentPage} /
																	${requestScope.OrderinfoPage.totalPage}页
																	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 请选择：第
																	<c:forEach begin="1"
																		end="${requestScope.OrderinfoPage.totalPage}" step="1"
																		var="i">
																		<c:if
																			test="${i==requestScope.OrderinfoPage.currentPage}">
						                           			【${i}】
					                           			</c:if>
																		<c:if
																			test="${i!=requestScope.OrderinfoPage.currentPage}">
																			<a href="orderinfo_search?currentPage=${i}">${i}</a>
																		</c:if>
																	</c:forEach>
																	页
																</tr>
														...
														<div class="form-body pal">
															...
															<div class="form-group">
																<div class="input-icon right">
																	<i class="fa fa-user"></i> <input id="inputuidl"
															...
															<div class="form-group">
																<div class="input-icon right">
																	<i class="fa fa-calendar"></i> <input
																		id="inputordertime" name="orderTime" type="text"
																		placeholder=" 下单时间" class="form-control" />
																</div>
															</div>
															<div class="form-group">
																<div class="input-icon right">
																	<i class="fa fa-money"></i> <input id="inputtotalmoney"
																		name="totalMoney" type="text" placeholder=" 总价钱 "
																		class="form-control" />
																</div>
															</div>
															<div class="form-group">
																<div class="input-icon right">
																	<i class="fa fa-smile-o"></i> <input
																		id="inputtotalamount" name="totalAmount" type="text"
																...
																<div class="input-icon right">
																	<i class="fa fa-smile-o"></i> <input
																		...
																		placeholder="邮寄地址" class="form-control" />
																</div>
															</div>
															<!--                                                     <div class="form-group"> -->
															<!--                                                         <div class="input-icon right"> -->
															<!--                                                             <i class="fa fa-smile-o"></i>          -->
															<!--                                                              <input id="inputproductid" name="totalAmount" type="text" placeholder="产品名称" class="form-control" /></div> -->
															<!--                                                     </div> -->
															<hr />
																		...
																		<div class="panel-body">
																			<div id="grid-layout-table-1" class="box jplist">
																				<div class="jplist-panel box panel-top">
																					<form action=orderinfo_SearchByUid>
																						Filter by UserId:<i class="fa fa-search"></i><input
																							name="customer.uid" type="text"
																							class="form-control"> <input
																							type="submit" name="搜索" />
																					</form>
																					<form action=po_SearchByPid>
																						Filter by ProductId:<i class="fa fa-search"></i><input
																							name="products.productId" type="text"
																							class="form-control"> <input
																							type="submit" name="搜索" />
																					</form>
																				</div>
