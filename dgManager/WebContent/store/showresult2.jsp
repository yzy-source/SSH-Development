							...
							<div class="col-lg-12">
								<div class="col-lg-12">
									<ul id="generalTab" class="nav nav-tabs responsive">
										<li class="active"><a href="show">查看库存</a></li>
										...
										<li><a href="showrecord">进出货记录</a></li>
									</ul>
														...
														<div class="panel panel-red">
															...
															<div class="panel-body">
																<table class="table table-hover">
																	...
																	<tbody>
																		<c:forEach items="${requestScope.searchPage.dataList}"
																			var="search" varStatus="status">

																			<tr>
																				<td>${status.count}</td>
																				<td>${search.products.productName}</td>
																				<td>${search.warehouse.WId}</td>
																				<td>${search.storeNum}</td>

																			</tr>
																		</c:forEach>
																		<tr>

																			<td>每页${requestScope.searchPage.pageSize}条记录
																				总共${requestScope.searchPage.totalPage}页</td>
																			<td>当前：第${requestScope.searchPage.currentPage} /
																				${requestScope.searchPage.totalPage}页</td>
																			<td>请选择：第 <c:forEach begin="1"
																					end="${requestScope.searchPage.totalPage}" step="1"
																					var="i">
																					<c:if
																						test="${i==requestScope.searchPage.currentPage}">
						【${i}】
					</c:if>
																					<c:if
																						test="${i!=requestScope.searchPage.currentPage}">
										...
										<div id="note-tab" class="tab-pane fade">
											<div class="row">
												<div class="col-lg-6">
													<form name="form3" action="search" method="post"
														class="hidden-sm hidden-xs">
														<div class="input-icon right text-black">
															<a href="javascript:document.form3.submit();"><i
													...
													<form name="form1" action="search" method="post"
														...
														<div class="input-icon right text-black">
															<a href="javascript:document.form1.submit();"><i
																class="fa fa-search"></i></a> <input type="text"
																placeholder="Search here..." name="productName"
																class="form-control text-black" />
														</div>
													</form>
