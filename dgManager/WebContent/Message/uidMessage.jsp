										...
										<div class="panel panel-pink">
											...
											<div class="panel-body">
												<table class="table table-hover table-striped">
													...
													<tbody>
														<c:forEach
															items="${requestScope.uidpage.umessagelist}" var="message">
															<tr>
																<td>${message.msgId}</td>
																<td>${message.customer.username}</td>
                                                                <td>${message.products.productName}</td>
                                                                <td>${message.content}</td>
                                                                <td>${message.msgTime}</td>							
																<td><a href="message_messDelete?msgId=${message.msgId}">
																<span class="badge badge-pink">删除留言</span>&nbsp;</a>
																	</rd></td>
															</tr>
														</c:forEach>
													</tbody>
												...
												<table align="center">
																...
																<td>每页&nbsp;&nbsp;${requestScope.uidpage.upagesize}&nbsp;&nbsp;条记录
										                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										                                                                     共&nbsp;&nbsp;${requestScope.uidpage.utotalcount}&nbsp;&nbsp;条记录
										                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										                                                                    共&nbsp;&nbsp;${requestScope.uidpage.utotalpage}&nbsp;&nbsp;页
										                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
										                           
																	<td>
																		<ul class="pagination mtm mbm">
																		       <li><a href="message_searchByUid?uidCurrentpage=${1}&customer.uid=${requestScope.uid}">首页</a></li>
																			    <c:if
																					test="${requestScope.uidpage.ucurrentpage==1}">
																					<li><a href="message_searchByUid?uidCurrentpage=${requestScope.uidpage.ucurrentpage}&customer.uid=${requestScope.uid}">&laquo;</a></li>

																				</c:if>
																				<c:if
																					test="${requestScope.uidpage.ucurrentpage!=1}">
																					<li><a href="message_searchByUid?uidCurrentpage=${requestScope.uidpage.ucurrentpage-1}&customer.uid=${requestScope.uid}">&laquo;</a></li>
																				</c:if>
																			<c:forEach begin="1" end="${requestScope.uidpage.utotalpage}" step="1" var="i">
																				<c:if
																					test="${i==requestScope.uidpage.ucurrentpage}">
																					<li class="active"><a href="#">${i}</a></li>

																				</c:if>
																				<c:if
																					test="${i!=requestScope.uidpage.ucurrentpage}">
																					<li><a href="message_searchByUid?uidCurrentpage=${i}&customer.uid=${requestScope.uid}">${i}</a></li>
																				</c:if>
																			</c:forEach>
																			<c:if
																					test="${requestScope.uidpage.ucurrentpage==requestScope.uidpage.utotalpage}">
																					<li><a href="message_searchByUid?uidCurrentpage=${requestScope.uidpage.ucurrentpage}&customer.uid=${requestScope.uid}">&raquo;</a></li>

																				</c:if>
																				<c:if
																					test="${requestScope.uidpage.ucurrentpage!=requestScope.uidpage.utotalpage}">
																					<li><a href="message_searchByUid?uidCurrentpage=${requestScope.uidpage.ucurrentpage+1}&customer.uid=${requestScope.uid} ">&raquo;</a></li>
																				</c:if>
																				<li><a href="message_searchByUid?uidCurrentpage=${requestScope.uidpage.utotalpage}&customer.uid=${requestScope.uid}">末页</a></li>
																		</ul>
